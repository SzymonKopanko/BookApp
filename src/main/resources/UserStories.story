...
Given has an existing user with the username pawel_nowak, email pawelnowak@wp.pl and password qwerty
...
Given has an existing user with the username jan_kowalski, email jankowalski@wp.pl, and password passwd
